...
def train_fair_nn(X_train, y_train, sensitive_directions, X_test=None, y_test=None, weights=None, n_units = [], lr=0.001, batch_size=1000, epoch=2000, verbose=False, activ_f = tf.nn.relu, l2_reg=0., lamb_init=2., subspace_epoch=10, subspace_step=0.1, eps=None, full_step=-1, full_epoch=10):
